...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/wnr/sand_wnr.js' />"></script>
    </jsp:attribute>
        ...
        <div role="page-header">
            <ax:form name="searchView0">
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label="샌드사" width="300px">
                            <input type="text" style="text-align: right;" data-ax-path="sub1_inventory_total"
                                   class="form-control" readonly="readonly">
                        </ax:td>
                        <ax:td label="하천사" width="300px">
                            <input type="text" style="text-align: right;" data-ax-path="sub2_inventory_total"
                                   class="form-control" readonly="readonly">
                        </ax:td>
                        <ax:td label="바다모래" width="300px">
                            <input type="text" style="text-align: right;" data-ax-path="sub3_inventory_total"
                                   class="form-control" readonly="readonly">
                        </ax:td>
                    </ax:tr>
                    <ax:tr>
            ...
            <ax:form name="formView01">
                <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                    ...
                    <ax:tr>
                        <ax:td label="샌드사" width="100%">
                            <div class="form-inline">
                                <input type="text" style="text-align: right;width: 185px;" data-ax-path="sub1_amount" placeholder="0.0"
                                       data-ax5formatter="money" class="form-control"/>
                                <span style="margin-right: 30px;">m<sup>3</sup></span>
                                <input type="text" style="text-align: right;width: 185px;" data-ax-path="sub1_price" placeholder="0"
                    ...
                    <ax:tr>
                        <ax:td label="하천사" width="100%">
                            <div class="form-inline">
                                <input type="text" style="text-align: right;width: 185px;" data-ax-path="sub2_amount" placeholder="0.0"
                                       data-ax5formatter="money" class="form-control"/>
                                <span style="margin-right: 30px;">m<sup>3</sup></span>
                                <input type="text" style="text-align: right;width: 185px;" data-ax-path="sub2_price" placeholder="0"
                                       data-ax5formatter="money(int)" class="form-control"/>
                                <span style="margin-right: 30px;">원</span>
                    ...
                    <ax:tr>
                        <ax:td label="바다모래" width="100%">
                            <div class="form-inline">
                                <input type="text" style="text-align: right;width: 185px;" data-ax-path="sub3_amount" placeholder="0.0"
                                       data-ax5formatter="money" class="form-control"/>
                                <span style="margin-right: 30px;">m<sup>3</sup></span>
                                <input type="text" style="text-align: right;width: 185px;" data-ax-path="sub3_price" placeholder="0"
                                       data-ax5formatter="money(int)" class="form-control"/>
                                <span style="margin-right: 30px;">원</span>
                                <div data-ax5select="select_warehousing_customer_3" data-ax5select-config="{}"></div>
                                <div data-ax5select="select_warehousing_car_3" data-ax5select-config="{}"></div>
