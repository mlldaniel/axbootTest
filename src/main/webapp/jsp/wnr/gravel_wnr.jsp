...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/wnr/gravel_wnr.js' />"></script>
    </jsp:attribute>
