package smartfactory.domain.init;

import smartfactory.domain.code.CommonCode;
import smartfactory.domain.code.CommonCodeService;
import smartfactory.domain.program.Program;
import smartfactory.domain.program.ProgramService;
import smartfactory.domain.program.menu.Menu;
import smartfactory.domain.program.menu.MenuService;
import smartfactory.domain.user.User;
import smartfactory.domain.user.UserService;
import smartfactory.domain.user.auth.UserAuth;
import smartfactory.domain.user.auth.UserAuthService;
import smartfactory.domain.user.auth.menu.AuthGroupMenu;
import smartfactory.domain.user.auth.menu.AuthGroupMenuService;
import smartfactory.domain.user.role.UserRole;
import smartfactory.domain.user.role.UserRoleService;
...
public class DatabaseInitService {
    ...
    public void createDefaultData() throws IOException {
        ...
        programService.save(Program.of("inventory_status", "입고 현황", "/jsp/inventory/inventory_status.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        programService.save(Program.of("inventory_graph", "재고 현황", "/jsp/inventory/inventory_graph.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        programService.save(Program.of("warehousing_customer", "입고처 관리", "/jsp/code/warehousing_customer.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        programService.save(Program.of("cement_wnr", "시멘트 입출고", "/jsp/wnr/cement_wnr.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        programService.save(Program.of("sand_wnr", "모래 입출고", "/jsp/wnr/sand_wnr.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        programService.save(Program.of("gravel_wnr", "자갈 입출고", "/jsp/wnr/gravel_wnr.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        programService.save(Program.of("admixture_wnr", "혼화재 입출고", "/jsp/wnr/admixture_wnr.jsp", "_self", "Y", "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        ...
        */
        ...
        menuService.save(Menu.of(17L, "SYSTEM_MANAGER", "재고 관리", null, null, 0, 2, null));
        menuService.save(Menu.of(18L, "SYSTEM_MANAGER", "입고 현황", JsonUtils.fromJson("{\"ko\":\"입고 현황\",\"en\":\"inventory_status\"}"), 17L, 1, 0, "inventory_status"));
        menuService.save(Menu.of(19L, "SYSTEM_MANAGER", "재고 현황", JsonUtils.fromJson("{\"ko\":\"재고 현황\",\"en\":\"inventory_graph\"}"), 17L, 1, 1, "inventory_graph"));
        menuService.save(Menu.of(20L, "SYSTEM_MANAGER", "입고처 관리", null, null, 0, 3, null));
        menuService.save(Menu.of(21L, "SYSTEM_MANAGER", "입고처 관리", JsonUtils.fromJson("{\"ko\":\"입고처 관리\",\"en\":\"warehousing_customer\"}"), 20L, 1, 0, "warehousing_customer"));
        menuService.save(Menu.of(22L, "SYSTEM_MANAGER", "입출고 관리", null, null, 0, 4, null));
        menuService.save(Menu.of(23L, "SYSTEM_MANAGER", "시멘트 입출고", JsonUtils.fromJson("{\"ko\":\"시멘트 입출고\",\"en\":\"cement_wnr\"}"), 22L, 1, 0, "cement_wnr"));
        menuService.save(Menu.of(24L, "SYSTEM_MANAGER", "모래 입출고", JsonUtils.fromJson("{\"ko\":\"모래 입출고\",\"en\":\"sand_wnr\"}"), 22L, 1, 1, "sand_wnr"));
        menuService.save(Menu.of(25L, "SYSTEM_MANAGER", "자갈 입출고", JsonUtils.fromJson("{\"ko\":\"자갈 입출고\",\"en\":\"gravel_wnr\"}"), 22L, 1, 2, "gravel_wnr"));
        menuService.save(Menu.of(26L, "SYSTEM_MANAGER", "혼화재 입출고", JsonUtils.fromJson("{\"ko\":\"혼화재 입출고\",\"en\":\"admixture_wnr\"}"), 22L, 1, 3, "admixture_wnr"));

        menuService.save(Menu.of(27L, "USER", "재고 관리", null, null, 0, 0, null));
        menuService.save(Menu.of(28L, "USER", "입고 현황", JsonUtils.fromJson("{\"ko\":\"입고 현황\",\"en\":\"inventory_status\"}"), 27L, 1, 0, "inventory_status"));
        menuService.save(Menu.of(29L, "USER", "재고 현황", JsonUtils.fromJson("{\"ko\":\"재고 현황\",\"en\":\"inventory_graph\"}"), 27L, 1, 1, "inventory_graph"));
        menuService.save(Menu.of(30L, "USER", "입고처 관리", null, null, 0, 1, null));
        menuService.save(Menu.of(31L, "USER", "입고처 관리", JsonUtils.fromJson("{\"ko\":\"입고처 관리\",\"en\":\"warehousing_customer\"}"), 30L, 1, 0, "warehousing_customer"));
        menuService.save(Menu.of(32L, "USER", "입출고 관리", null, null, 0, 2, null));
        menuService.save(Menu.of(33L, "USER", "시멘트 입출고", JsonUtils.fromJson("{\"ko\":\"시멘트 입출고\",\"en\":\"cement_wnr\"}"), 32L, 1, 0, "cement_wnr"));
        menuService.save(Menu.of(34L, "USER", "모래 입출고", JsonUtils.fromJson("{\"ko\":\"모래 입출고\",\"en\":\"sand_wnr\"}"), 32L, 1, 1, "sand_wnr"));
        menuService.save(Menu.of(35L, "USER", "자갈 입출고", JsonUtils.fromJson("{\"ko\":\"자갈 입출고\",\"en\":\"gravel_wnr\"}"), 32L, 1, 2, "gravel_wnr"));
        menuService.save(Menu.of(36L, "USER", "혼화재 입출고", JsonUtils.fromJson("{\"ko\":\"혼화재 입출고\",\"en\":\"admixture_wnr\"}"), 32L, 1, 3, "admixture_wnr"));
        ...
        commonCodeService.save(CommonCode.of("CATEGORY_CD", "카테고리 대분류", "01", "시멘트", 1));
        commonCodeService.save(CommonCode.of("CATEGORY_CD", "카테고리 대분류", "02", "모래", 2));
        commonCodeService.save(CommonCode.of("CATEGORY_CD", "카테고리 대분류", "03", "자갈", 3));
        commonCodeService.save(CommonCode.of("CATEGORY_CD", "카테고리 대분류", "04", "혼화재", 4));

        commonCodeService.save(CommonCode.of("CATEGORY_CD_01", "시멘트", "01", "PC", 1));
        commonCodeService.save(CommonCode.of("CATEGORY_CD_01", "시멘트", "02", "슬라그", 2));
        commonCodeService.save(CommonCode.of("CATEGORY_CD_01", "시멘트", "03", "미분말", 3));

        commonCodeService.save(CommonCode.of("CATEGORY_CD_02", "모래", "01", "샌드사", 1));
        commonCodeService.save(CommonCode.of("CATEGORY_CD_02", "모래", "02", "하천사", 2));
        commonCodeService.save(CommonCode.of("CATEGORY_CD_02", "모래", "03", "바다모래", 3));

        commonCodeService.save(CommonCode.of("CATEGORY_CD_03", "자갈", "01", "자갈", 1));

        commonCodeService.save(CommonCode.of("CATEGORY_CD_04", "혼화제", "01", "PC", 1));
        commonCodeService.save(CommonCode.of("CATEGORY_CD_04", "혼화제", "02", "일반", 2));

//        commonCodeService.save(CommonCode.of("DEALSECTION_CD", "거래구분", "BU", "매입", 1));
//        commonCodeService.save(CommonCode.of("DEALSECTION_CD", "거래구분", "SE", "매출", 2));
//        commonCodeService.save(CommonCode.of("DEALSECTION_CD", "거래구분", "BS", "본사", 3));
//        commonCodeService.save(CommonCode.of("DELIVERYAREA_CD", "납기장소", "01", "포항종합운동장", 1));
//        commonCodeService.save(CommonCode.of("DELIVERYAREA_CD", "납기장소", "02", "신항만", 2));
//        commonCodeService.save(CommonCode.of("DEPARTMENT_CD", "부서구분", "GD", "총무부", 2));
//        commonCodeService.save(CommonCode.of("DEPARTMENT_CD", "부서구분", "MD", "자재부", 1));
//        commonCodeService.save(CommonCode.of("DEPARTMENT_CD", "부서구분", "PD", "생산부", 4));
//        commonCodeService.save(CommonCode.of("DEPARTMENT_CD", "부서구분", "TD", "검사부", 3));
//        commonCodeService.save(CommonCode.of("MATSECTION_CD", "재료구분", "OM", "원자재", 1));
//        commonCodeService.save(CommonCode.of("MATSECTION_CD", "재료구분", "OS", "외주생산", 2));
//        commonCodeService.save(CommonCode.of("MATSECTION_CD", "재료구분", "SM", "자체제작", 3));
//        commonCodeService.save(CommonCode.of("OUTSECTION_CD", "외주구분", "DM", "직영", 2));
//        commonCodeService.save(CommonCode.of("OUTSECTION_CD", "외주구분", "OS", "외주", 1));
//        commonCodeService.save(CommonCode.of("PACKING_CD", "포장여부", "PK", "정상", 1));
//        commonCodeService.save(CommonCode.of("PACKING_CD", "포장여부", "UP", "포장불필요", 2));
//        commonCodeService.save(CommonCode.of("PROCESS_CD", "생산공정", "AS", "조립", 2));
//        commonCodeService.save(CommonCode.of("PROCESS_CD", "생산공정", "OR", "주문등록", 1));
//        commonCodeService.save(CommonCode.of("PROCESS_CD", "생산공정", "PA", "도장", 3));
//        commonCodeService.save(CommonCode.of("PROCESS_CD", "생산공정", "SS", "출하대기", 6));
//        commonCodeService.save(CommonCode.of("PROCESS_CD", "생산공정", "TS", "판정대기", 4));
//        commonCodeService.save(CommonCode.of("PROCESS_CD", "생산공정", "WS", "입고대기", 5));
//        commonCodeService.save(CommonCode.of("TEST_RESULT", "합불판정", "F", "불합격", 2));
//        commonCodeService.save(CommonCode.of("TEST_RESULT", "합불판정", "S", "합격", 1));
//        commonCodeService.save(CommonCode.of("TIMECARD_CD", "근태구분", "01", "근무", 1));
//        commonCodeService.save(CommonCode.of("TIMECARD_CD", "근태구분", "02", "휴무", 2));
//        commonCodeService.save(CommonCode.of("TIMECARD_CD", "근태구분", "03", "외출", 3));
//        commonCodeService.save(CommonCode.of("TRANSPORT_CD", "운송사", "01", "대한통운", 1));
//        commonCodeService.save(CommonCode.of("TRANSPORT_CD", "운송사", "02", "서진통운", 2));
//        commonCodeService.save(CommonCode.of("WAREHOUSE_CD", "입고창고", "AW", "창고A동", 1));
//        commonCodeService.save(CommonCode.of("WAREHOUSE_CD", "입고창고", "OP", "야적장", 2));
        /*
        ...
        */
        ...
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 17L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 18L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 19L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 20L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 21L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 22L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 23L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 24L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 25L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 26L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 27L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 28L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 29L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 30L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 31L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 32L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 33L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 34L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 35L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0001", 36L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));

        authGroupMenuService.save(AuthGroupMenu.of("S0002", 17L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 18L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 19L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 20L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 21L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 22L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 23L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 24L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 25L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 26L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 27L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 28L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 29L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 30L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 31L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 32L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 33L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 34L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 35L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
        authGroupMenuService.save(AuthGroupMenu.of("S0002", 36L, "Y", "Y", "N", "Y", "N", "N", "N", "N", "N"));
    }
